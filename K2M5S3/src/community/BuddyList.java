...
public class BuddyList {
    ...
    public void addBuddyRequest(MapleClient c, int cidFrom, String nameFrom, int channelFrom, int levelFrom, int jobFrom, String groupName) {
        ...
        if (pendingRequests.isEmpty()) {
            c.getSession().write(MainPacketCreator.requestBuddylistAdd(c, cidFrom, nameFrom, levelFrom, jobFrom, false));
            c.getSession().write(MainPacketCreator.buddylistMessage((byte) 0x31, null));
        } else {
