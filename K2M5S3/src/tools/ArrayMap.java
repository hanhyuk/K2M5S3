...
public class ArrayMap<K, V> extends AbstractMap<K, V> {
	 ...
	 *
	 * @param map
	 *            The <code>java.util.Map</code> containing keys and values to
	 *            import.
	 */
	 ...
	 *            The initial size of the ArrayMap.
	 */
	 ...
	 *
	 * @param key
	 *            The key of <code>value</code>
	 * @param value
	 *            The value to insert into the ArrayMap.
