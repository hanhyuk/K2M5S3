...
public class ExpirationTool {
    ...
    /**
     * 현재 시간에 <code>hour</code>시간 만큼의 시간을 더하고 <code>deafults</code>가 true일 경우
     * 그 이하의 시간을 초기화 합니다.
     * <br>
     * 예를 들어 hour가 2일 경우
     * 초기화 전 : 2010/2/12 12:52:48
     * 초기화 후 : 2010/2/12 14:00:00
     * </br>
     *
     * @param hour 더할 시간
    ...
    /**
     * 현재 시간에 <code>day</code>일 만큼의 시간을 더하고 <code>deafults</code>가 true일 경우
     * 그 이하의 시간을 초기화 합니다.
     * <br>
     * 예를 들어 day가 1일 경우
     * 초기화 전 : 2010/2/12 12:52:48
     * 초기화 후 : 2010/2/13 00:00:00
     * </br>
     *
     * @param hour 더할 시간
     * @param deafults 초기화 여부
    ...
    /**
     * 현재 시간에 <code>hour</code>시간 <code>minute</code>분 만큼의 시간을 더합니다.
     * 단, 초기화는 할 수 없습니다.
     *
     * @param hour 더할 시간
     * @param minute 더할 분
    ...
    /**
     * 현재 시간에 <code>day</code>일 <code>hour</code>시간 만큼의 시간을 더합니다.
     * 단, 초기화는 할 수 없습니다.
     *
     * @param day 더할 시간
     * @param hour 더할 분
    ...
    /**
     * 현재 시간에 <code>day</code>일 <code>hour</code>시간 <code>minute</code>분 만큼의 시간을 더합니다.
     * 단, 초기화는 할 수 없습니다.
     * @param day 더할 일
     * @param hour 더할 시간
     * @param minute 더할 분
