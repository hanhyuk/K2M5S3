...
public class BuddyListHandler {
    ...
    private static final void nextPendingRequest(final MapleClient c) {
        ...
        if (pendingBuddyRequest != null) {
            c.getSession().write(MainPacketCreator.requestBuddylistAdd(c, pendingBuddyRequest.getId(), pendingBuddyRequest.getName(), pendingBuddyRequest.getLevel(), pendingBuddyRequest.getJob(), false));
        }
    }
