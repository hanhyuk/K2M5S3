    ...
    public static void UseScriptedNPCItem(ReadingMaple rh, MapleClient c, MapleCharacter chr) {
        ...
        if (toUse != null && toUse.getQuantity() >= 1 && toUse.getItemId() == itemId) {
            switch (toUse.getItemId()) {
                ...
                case 2433178: //할로윈 데미지 스킨 : 20
                case 2433631: //네네치킨 데미지스킨 : 22
                case 2433715: //색동 데미지 스킨 : 23
                case 2433804: //커플부대 데미지 스킨 : 24
                case 5680343: //별별 데미지 스킨 : 25
                case 2433913: //예티X페페 데미지스킨 : 26
                case 2433980: //슬라임X주황버섯 데미지스킨 : 27
                case 2433981: //핑크빈 데미지스킨 : 28
                case 2433990: //돼지바 데미지 스킨 : 29
                case 2434248: //무지개 봉봉 데미지 스킨 : 34
                case 2434273: //밤하늘 데미지스킨 : 35
                case 2434274: //마시멜로 데미지 스킨 : 36
                case 2434289: //무릉도장 데미지 스킨 : 37
                case 2434390: //곰돌이 데미지 스킨 : 38
                case 2434391: //파왕 데미지 스킨 : 39
                case 5680395: //폭염 데미지스킨 : 40
                case 2434528: //USA 데미지 스킨 : 41
                case 2434529: //츄러스 데미지 스킨 : 42
                case 2434530: //싱가폴 야경 데미지 스킨 : 43
                case 2434546: //낙서쟁이 데니스 데미지스킨 : 44
                case 2434574: //만월 데미지 스킨 : 45
                case 2434575: //햇님이 반짝 데미지 스킨 : 46
                case 2434542: //노히메 데미지스킨 : 47
                case 2434654: //무르무르 데미지 스킨 : 48
                case 2434655: //구미호 데미지 스킨 : 49
                case 2434661: //좀비 데미지 스킨 : 50
                case 2434710: //M.V.P 스페셜 전용 데미지스킨 : 51
                case 2434734: //블랙헤븐 데미지 스킨 : 52
                case 2434824: //몬스터파크 데미지 스킨 : 53
                case 2434950: //젤리빈 데미지 스킨 : 74
                case 2434951: //소프트 데미지 스킨 : 75
                case 2435030: //크리스마스 전구 데미지 스킨 : 76
                case 2435043: //히어로즈 팬텀 데미지 스킨 : 77
                case 2435044: //히어로즈 메르세데스  데미지 스킨 : 78
                case 2435046: //폭죽 데미지 스킨 : 79
                case 2435047: //하트풍선 데미지 스킨 : 80
                case 2435140: //네온사인 데미지 스킨 : 81
                case 2435141: //얼음? 데미지 스킨 : 82
                case 2435179: //캔디 데미지 스킨 : 83
                case 2435162: //앤티크 데미지 스킨 : 84
                case 2435157: //붓글씨 데미지 스킨 : 85
                case 2435158: //익스플로전 데미지 스킨 : 86
                case 2435159: //스노윙 데미지 스킨 : 87
                case 2435160: //미호 데미지 스킨 : 88
                case 2435161: //도넛 데미지 스킨 : 89
                case 2435182: //악보 데미지 스킨 : 90
                case 2435166: //월묘 데미지 스킨 : 91
                case 2435184: { //근성 데미지 스킨 : 92
    ...
    public static void UseCashItem(ReadingMaple rh, MapleClient c) {
        ...
        switch (itemId) {
            ...
            case 5051001: {
                ...
                c.getSession().write(MainPacketCreator.updateSp(c.getPlayer(), false));
                used = true;
                break;
            }
            case 5050100: {
            ...
            case 5062009: { // 레드큐브
                ...
                if (item != null && c.getPlayer().getInventory(MapleInventoryType.USE).getNumFreeSlot() >= 1) {
                    ...
                    if (eq.getState() >= 17) {
                        ...
                        c.getPlayer().getMap().broadcastMessage(MainPacketCreator.showCubeEffect(c.getPlayer().getId(), 5062009));
                        if (tar > 0) {
                            c.getPlayer().forceReAddItem_NoUpdate(item, MapleInventoryType.EQUIP);
                        } else {
            ...
            case 5062090: { //메모리얼 큐브
                ...
                if (item != null && c.getPlayer().getInventory(MapleInventoryType.USE).getNumFreeSlot() >= 1) {
                    ...
                    if (eq.getState() >= 17) {
                        ...
                        c.getSession().write(MainPacketCreator.MemorialCubeWindow(c.getPlayer(), item, 5062090));
            ...
            case 5062010: {
                ...
                if (item != null && c.getPlayer().getInventory(MapleInventoryType.USE).getNumFreeSlot() >= 1) {
                    ...
                    if (eq.getState() >= 17) {
                        ...
                        eq.setPotential2(potential(level, a, false, eq.getItemId()));
                        eq.setPotential3(eq.getLines() == 3 ? potential(level, a, false, eq.getItemId()) : 0);
                        c.getSession().write(MainPacketCreator.BlackCubeStart(c.getPlayer(), item, 5062010, eq.getLines()));
                        c.getPlayer().getMap().broadcastMessage(MainPacketCreator.BlackCubeEffect(c.getPlayer().getId(), 5062010));
...
//        }
    ...
    public static void UseManySetCube(MapleClient c, ReadingMaple rh) {
        byte BA = rh.readByte();
        Equip AE = null;
