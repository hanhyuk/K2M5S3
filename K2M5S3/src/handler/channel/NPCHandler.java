...
public class NPCHandler {
    ...
    public static Packet NPCAnimation(ReadingMaple slea, MapleClient c) {
	...
	switch (action) {
		...
		c.getSession().write(MainPacketCreator.showSpecialEffect(0x0E)); //1.2.251+, (+1) 
		chr.getMap().broadcastMessage(chr, MainPacketCreator.showSpecialEffect(chr.getId(), 0x0E), false); //1.2.251+, (+1)
		break;
	    }
