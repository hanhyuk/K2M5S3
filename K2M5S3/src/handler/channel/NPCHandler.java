...
public class NPCHandler {
	...
	public static final void QuestAction(final ReadingMaple rh, final MapleClient c, final MapleCharacter chr) {
		...
		case 2: { // Complete Quest
			...
			c.getSession().write(MainPacketCreator.showSpecialEffect(0x0E)); // 1.2.251+,
																				// (+1)
			chr.getMap().broadcastMessage(chr, MainPacketCreator.showSpecialEffect(chr.getId(), 0x0E), false); // 1.2.251+,
																												// (+1)
			break;
		}
