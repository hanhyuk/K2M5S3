...
public class DueyItems {
	private byte upgradeSlots = 0, level = 0, vicioushammer = 0, itemLevel = 0, enhance = 0, state = 0, lines = 0, fire = -1, bossdmg = 0, alldmgp = 0, allstatp = 0, downlevel = 0;
	private short str = 0, dex = 0, _int = 0, luk = 0, hp = 0, mp = 0, watk = 0, matk = 0, wdef = 0, mdef = 0, acc = 0, avoid = 0, hands = 0, speed = 0, jump = 0, hpR = 0, mpR = 0, IgnoreWdef = 0, soulenchanter = 0, soulname = 0;
	private int soulskill = 0;
	private int job = 0, potential = 0, durability = -1, potential1 = 0, potential2 = 0, potential3 = 0, potential4 = 0, potential5 = 0, potential6 = 0, potential7 = 0, anvil = 0, itemEXP = 0;
	...
	public void resetPotential_Fuse(boolean a, boolean nopotential) { // equip
																		// first
																		// receive
		int epic = a ? 20 : 10;
		int unique = a ? 10 : 5;
