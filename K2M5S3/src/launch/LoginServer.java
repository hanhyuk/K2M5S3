...
public class LoginServer {
	...
	/**
	 * 서버와 클라이언트는 소켓통신을 한다. 그리고 클라이언트가 실행되면 로그인 서버로 접속을 시도 하고,
	 * 이 연결을 위한 기본 설정을 이곳에서 한다. 
	 */
	public void run_startup_configurations() {
		try {
			...
			System.out.println("[알림] 로그인서버가 " + LOGIN_PORT + " 포트를 성공적으로 개방하였습니다.");
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
