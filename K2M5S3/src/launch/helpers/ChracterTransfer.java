...
public class ChracterTransfer implements Externalizable {
    ...
    public int characterid, accountid, fame, str, dex, int_, luk, maxhp, maxmp, mp, hpApUsed, mpApUsed,
	    ...
	    buddysize, partyid, messengerid, messengerposition, nxcash, vpoints, MaplePoints, realcash,
    ...
    public Object inventorys, skillmacro, keymap, savedlocation, famedcharacters, cashinventory, steelskills,
	    storage, rocks, wishlist, InfoQuest, remainingSp, rebuyList, profession, stats, innerSkills, android, extendedSlots;
    ...
    public final Map<Integer, Object> Skills = new LinkedHashMap<>(); // Skillid instead of Skill.java, as it's huge. Cant be transporting Skill.java and MapleStatEffect.java
    ...
    public int rankpoint, gp, Soul, betaclothes;
