...
public class Equip extends Item implements IEquip, Serializable {
    ...
    private byte upgradeSlots, level, vicioushammer, itemLevel, enhance, state, lines, fire = -1, bossdmg, alldmgp, allstatp;
    private short str, dex, _int, luk, hp, mp, watk, matk, wdef, mdef, acc, avoid, hands, speed, jump, hpR, mpR, IgnoreWdef, downlevel, soulname, soulenchanter, soulpotential, itemtrace, charmExp;
