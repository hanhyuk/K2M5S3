...
public enum MonsterStatus implements GlobalBuffStat {
    ...
    /* 테스트 라인 */
    STING_EXPLOSION         (0x0, 0),
    WATK                    (0x0, 0), 
    MDEF                    (0x800000, 0), //1.2.252 Ok.
    ...
    SPEED                   (0x0, 0),
    SHOWDOWN                (0x0, 0),
    WEAPON_ATTACK_UP        (0x0, 0),
    WEAPON_DEFENSE_UP       (0x0, 0),
    MAGIC_ATTACK_UP         (0x0, 0),
    MAGIC_DEFENSE_UP        (0x0, 0),
    /* 아래 부터는 미완성 */
    DOOM                    (0x0),
    SHADOW_WEB              (0x0), 
    WEAPON_IMMUNITY         (0x0),
    ...
    VENOMOUS_WEAPON         (0x0), 
    HYPNOTIZE               (0x0),
    WEAPON_DAMAGE_REFLECT   (0x0),
    MAGIC_DAMAGE_REFLECT    (0x0),
    SUMMON                  (0x0), 
    /* 1.2.239 테스트 라인 종료 */
    ;
