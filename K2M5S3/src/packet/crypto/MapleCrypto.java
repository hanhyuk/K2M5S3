...
public class MapleCrypto {
	...
	// 1:239.1 :: '9F' E4 18 9F '15' 42 00 26 'FE' 4C D1 21 '04' 93 2F B3 '8F'
	// 73 53 40 '43' 8A AF 7E 'CA' 6F D5 CF 'D3' A1 95 CE
	// 1:240.1 :: '29' 23 BE 84 'E1' 6C D6 AE '52' 90 49 F1 'F1' BB E9 EB 'B3'
	// A6 DB 3C '87' 0C 3E 99 '24' 5E 0D 1C '06' B7 47 DE
	// 1.241.1 :: 'B3' 12 4D C8 '43' BB 8B A6 '1F' 03 5A 7D '09' 38 25 1F '5D'
	// D4 CB FC '96' F5 45 3B '13' 0D 89 0A '1C' DB AE 32
	// 1.242.2 :: '88' 81 38 61 '6B' 68 12 62 'F9' 54 D0 E7 '71' 17 48 78 '0D'
	// 92 29 1D '86' 29 99 72 'DB' 74 1C FA '4F' 37 B8 B5
	// 1.243.2 :: '20' 9A 50 EE '40' 78 36 FD '12' 49 32 F6 '9E' 7D 49 DC 'AD'
	// 4F 14 F2 '44' 40 66 D0 '6B' C4 30 B7 '32' 3B A1 22
	// 1.244.2 :: '18' 70 92 DA '64' 54 CE B1 '85' 3E 69 15 'F8' 46 6A 04 '96'
	// 73 0E D9 '16' 2F 67 68 'D4' F7 4A 4A 'D0' 57 68 76
	// 1.250.3 :: '76' 2D D0 C2 'C9' CD 68 D4 '49' 6A 79 25 '08' 61 40 14 'B1'
	// 3B 6A A5 '11' 28 C1 8C 'D6' A9 0B 87 '97' 8C 2F F1
	// 1.251.1 :: '10' 50 9B C8 '81' 43 29 28 '8A' F6 E9 9E '47' A1 81 48 '31'
	// 6C CD A4 '9E' DE 81 A3 '8C' 98 10 FF '9A' 43 CD CF
	// 1.252.1 :: '5E' 4E E1 30 '9C' FE D9 71 '9F' E2 A5 E2 '0C' 9B B4 47 '65'
	// 38 2A 46 '89' A9 82 79 '7A' 76 78 C2 '63' B1 26 DF
	// 1.253.1 :: 'DA' 29 6D 3E '62' E0 96 12 '34' BF 39 A6 '3F' 89 5E F1 '6D'
	// 0E E3 6C '28' A1 1E 20 '1D' CB C2 03 '3F' 41 07 84

	private static final byte[] sSecretKey = new byte[] { (byte) 0xDA, 0x00, 0x00, 0x00, (byte) 0x62, 0x00, 0x00, 0x00,
			(byte) 0x34, 0x00, 0x00, 0x00, (byte) 0x3F, 0x00, 0x00, 0x00, (byte) 0x6D, 0x00, 0x00, 0x00, (byte) 0x28,
			0x00, 0x00, 0x00, (byte) 0x1D, 0x00, 0x00, 0x00, (byte) 0x3F, 0x00, 0x00, 0x00 };
