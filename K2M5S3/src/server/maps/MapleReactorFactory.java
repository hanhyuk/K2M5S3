		    ...
		    while (reactorInfoData != null) {
                        for (MapleData rdata : reactorInfoData.getChildren()) {
                            ...
                            if (type == 100) { //reactor waits for item
                                reactItem = new Pair<Integer, Integer>(MapleDataTool.getIntConvert("0", rdata), MapleDataTool.getIntConvert("1", rdata));
                            ...
                            stats.addState((byte) i, Byte.parseByte(rdata.getName()), type, reactItem, (byte) MapleDataTool.getIntConvert("state", rdata));
                        }
			i++;
