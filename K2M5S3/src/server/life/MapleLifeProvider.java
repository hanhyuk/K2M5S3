...
public class MapleLifeProvider {
	private static final Logger logger = LoggerFactory.getLogger(MapleLifeProvider.class);
	...
	public static AbstractLoadedMapleLife getLife(int id, String type) {
		if (type.equalsIgnoreCase("n")) {
			...
			logger.debug("Unknown Life type: {}", type);
			return null;
		}
	}
	...
	public static MapleMonster getMonster(int mid) {
		...
		if (stats == null) {
			...
			stats.setBoss(MapleDataTool.getIntConvert("boss", monsterInfoData, 0) > 0 || mid == 8810018 || (mid >= 8810118 && mid <= 8810122) || mid == 9410066);
			...
			if (banishData != null) {
				stats.setBanishInfo(new BanishInfo(MapleDataTool.getString("banMsg", banishData), MapleDataTool.getInt("banMap/0/field", banishData, -1),
			...
			if (monsterSkillData != null) {
				...
				while (monsterSkillData.getChildByPath(Integer.toString(i)) != null) {
					skills.add(new Pair<Integer, Integer>(Integer.valueOf(MapleDataTool.getInt(i + "/skill", monsterSkillData, 0)),
