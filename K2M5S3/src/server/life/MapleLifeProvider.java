...
//                System.out.println("x : "+rs.getInt("x")+" y : "+rs.getInt("y")+" name : "+rs.getString("name")+" hair : "+rs.getInt("hair")+" face : "+rs.getInt("face")+" skin : "+rs.getByte("skin")+" dir : "+rs.getByte("dir"));
//                System.out.println("x : "+(npc.getRx0() + 50)+" y : "+npc.getCy()+" name : "+npc.getName()+" hair : "+npc.getHair()+" face : "+npc.getFace()+" skin : "+npc.getSkin()+" dir : "+npc.getDirection());
