...
public class MapleMonsterStats {
    ...
    private int  exp, mp, removeAfter, buffToGive, fixedDamage, selfDestruction_hp, charismaEXP, link, pad, mad, acc, pushed, speed;
    private int smartPhase = -1;
    private long hp, finalmaxhp;
    private boolean boss, undead, ffaLoot, firstAttack, isExplosiveReward, mobile, fly, onlyNormalAttack, friendly, changeable, invincible;
