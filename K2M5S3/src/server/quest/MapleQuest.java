...
public class MapleQuest {
    ...
    public void complete(MapleCharacter c, int npc, Integer selection) {
       ...
       c.getClient().getSession().write(MainPacketCreator.showSpecialEffect(0x0E)); //1.2.251+, (+1)
       c.getMap().broadcastMessage(c, MainPacketCreator.showSpecialEffect(c.getId(), 0x0E), false); //1.2.251+, (+1)
    }
